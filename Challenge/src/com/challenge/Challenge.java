...
public class Challenge {
	public static void main(String[] args) {
        ...
        System.out.println(getDurationString(120, 36));
        System.out.println(getDurationString(0, 3660));
        System.out.println(getDurationString(63, 6));
        System.out.println(getDurationString(60)+"second");
        System.out.println(getDurationString(59)+"second");
        System.out.println(getDurationString(120)+"second");
